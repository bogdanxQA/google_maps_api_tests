...
Этот проект написан в рамках ознакомления с инструментами автоматизации тестирования API. Здесь я практикую написание автотестов на Python с использованием **pytest**, **requests** и **Allure** на примере публичного API Google Maps. Проект не претендует на коммерческий уровень — это учебный пример, демонстрирующий промежуточный этап освоения данных библиотек.
